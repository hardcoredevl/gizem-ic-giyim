...
const OrderForm = () => {
  ...
  return (
    <div className="font-[sans-serif] bg-white p-4 lg:mt-24 flex justify-center items-center lg:pb-28">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 max-md:order-1">
            ...
            <p className="text-gray-800 text-sm mt-4 max-w-[500px]">
              3D Secure ile güvenli ödeme yapabilirsiniz. Ödeme yaptıktan sonra
              size verilen sipariş numarasını saklayın. Faturanız telefon
              numaranıza sms olarak gönderilecektir.
            </p>
                ...
                <div className="grid gap-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <input
                        ...
                        name="isim"
                        placeholder="Adınız"
                        className="px-4 py-3.5 bg-gray-100 text-gray-800 w-full text-sm border rounded-md focus:border-orange-500 focus:bg-transparent outline-none"
                        value={formData.isim}
                  ...
                  <div>
                    <textarea
                      ...
                      placeholder="Adres"
                      rows={3}
                      className="px-4 py-3.5 bg-gray-100 text-gray-800 w-full text-sm border rounded-md focus:border-orange-500 focus:bg-transparent outline-none max-h-[150px]"
            ...
            {showPaymentForm && (
              <form
                className="mt-8 max-w-lg  lg:pb-32"
                ref={form}
                onSubmit={sendEmail}
              >
                <div className="grid gap-4">
                  ...
                  <div className="flex bg-gray-100 border rounded-md focus-within:border-orange-500 focus-within:bg-transparent overflow-hidden">
                    <svg
                  ...
                  <div className="flex justify-between mt-8">
                    ...
                    <button
                      type="submit"
                      className="w-32 py-2.5 text-sm bg-orange-500 text-white rounded-md hover:bg-orange-600 tracking-wide"
                    >
                      Ödeme Yap
                    </button>
                  </div>
          ...
          <div className="bg-gray-100 p-6 rounded-md max-h-[270px]">
            ...
            <ul className="text-gray-800 mt-8 space-y-4">
              <li className="flex flex-wrap gap-4 text-sm">
                İç Çamaşırı <span className="ml-auto font-bold">100 TL</span>
              </li>
              <li className="flex flex-wrap gap-4 text-sm">
                Kargo <span className="ml-auto font-bold">30 TL</span>
              </li>
              <li className="flex flex-wrap gap-4 text-sm">
                Ücretsiz Kargo <span className="ml-auto font-bold">-30 TL</span>
              </li>
